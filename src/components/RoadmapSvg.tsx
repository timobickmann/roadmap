...
function RoadmapSvg() {
  ...
  if (roadmapStatus) {
    const htmlItem = roadmapStatus.find((item) => item.name === "html");
    let htmlColor = "#fff";
    {
      htmlItem.status === "finished" && (htmlColor = "green");
    }
    {
      htmlItem.status === "todo" && (htmlColor = "red");
    }
    ...
    return (
      ...
      >
        <path id="ArtBoard1" fill="none" d="M0 0H405.911V962.176H0z" />
        <path
        ...
        <g>
          ...
          >
            ...
            >
              {"V"}
              <tspan x="401.033px 407.707px" y="85.831px 85.831px">
                {"ue"}
              </tspan>
            </text>
            <text
